    ...
    <section className="contract-hire-container">
      ...
      >
        <div className="contract-hire-text">
          <h4 className="contract-hire-title">CONTRACT HIRE</h4>
          <h2 className="contract-hire-heading">
            Finding You The Leaders <br /> Of Tomorrow.
          </h2>
          <p className="contract-hire-description">
            Our contract hire staffing solution provides flexible recruitment to
            suit any situation, covering both long- and short-term requirements
