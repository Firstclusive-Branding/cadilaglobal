...
//         `${baseURL}/api/admin/jobposting/getall`,
//         {
//           pageno: page,
//           search,
...
//     try {
//       await axios.post(
//         `${baseURL}/api/admin/jobposting/${endpoint}`,
//         payload,
//         getAuthHeaders()
//       );
//       setForm({
...
//     try {
//       await axios.post(
//         `${baseURL}/api/admin/jobposting/delete`,
//         { _id },
//         getAuthHeaders()
//       );
//       fetchJobs();
...
//     try {
//       await axios.post(
//         `${baseURL}/api/admin/jobposting/approved/${jobId}`,
//         { approved },
//         getAuthHeaders()
//       );
//       fetchJobs();
