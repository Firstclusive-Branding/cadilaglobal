...
const testimonials = [
  {
    ...
    role: "CANDIDATE",
    review:
      "I was at a crossroads in my career and needed professional guidance to make a successful transition. Cadila Global LLC not only understood my unique situation but also tailored their services to meet my specific needs.",
  },
  {
    image: user2,
    ...
    role: "CANDIDATE",
    review:
      "I can't express my gratitude enough to Cadila Global LLC for their invaluable support in my job search journey. From refining my resume to providing personalized interview and coaching.",
  },
];
